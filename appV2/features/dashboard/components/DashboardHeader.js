...
import LanguageSelector from '@/appV2/features/settings/components/LanguageSelector';
...
import ImportCSVModal from '@/appV2/features/trades/components/ImportCSVModal';
    ...
    <>
      <header className="border-b sticky top-0 z-30 backdrop-blur-xl px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-4 border-slate-200 dark:border-white/5 bg-white/90 dark:bg-slate-950/60 text-slate-900 dark:text-white">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <button className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-teal-500 to-emerald-500 text-white rounded-xl text-xs font-bold transition shadow-lg shadow-teal-500/20 cursor-pointer">
